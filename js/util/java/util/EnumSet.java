...
public class EnumSet<E extends Enum<E>> extends AbstractSet<E>
    ...
    ArrayList<E> enums = new ArrayList<E>();
    ...
    public static <E extends Enum<E>> EnumSet<E> noneOf(Class<E> elementType) {
        return new EnumSet<E>(elementType);
    }
    ...
    public static <E extends Enum<E>> EnumSet<E> allOf(Class<E> elementType) {
        ...
        set.addAll(Arrays.asList(elementType.getEnumConstants()));
        return set;
    }
    ...
    public static <E extends Enum<E>> EnumSet<E> copyOf(Collection<E> c) {
        ...
        EnumSet<E> set = new EnumSet<E>((Class<E>) element.getClass()); // Used to be: getDeclaringClass
        set.add(element);
    ...
    public static <E extends Enum<E>> EnumSet<E> of(E e) {
        EnumSet<E> set = new EnumSet<E>((Class<E>) e.getClass()); // Used to be: getDeclaringClass
        set.add(e);
        return set;
    }
