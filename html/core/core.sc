...
html.core extends sys.std {  // Extending sys.std because we override the standard file type handling.  Need to then have us after sys.std.
   ...
   public void start() {
      ...
      templateResourceLang = new sc.lang.HTMLLanguage();
      ...
      if (system.getLayerByDirName("js.template") == null && system.getLayerByDirName("servlet.schtml") == null && system.getLayerByDirName("wicket.core") == null && system.getLayerByDirName("html.schtml") == null && system.getLayerByDirName("js.schtml") == null) {
